                ...
                <tbody>
                  ...
                  <tr>
                    <td class="text-center" colspan="5">
                     <a href="/board/list?page=${curpage>1?curpage-1:curpag }" class="btn btn-sm btn-warning">이전</a>
                     ${curpage } page / ${totalpage } pages
                     <a href="/board/list?page=${curpage<totalpage?curpage+1:curpag }" class="btn btn-sm btn-warning">다음</a>
                    </td>
                  </tr>
                </tbody>
              </table>
