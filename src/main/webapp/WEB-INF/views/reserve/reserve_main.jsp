		           ...
		           <table class="table">
		             <tr>
		              <td class="text-center" colspan="2">
		                <select class="form-control r_select" 
		                v-model="store.loc" @change="store.locChange">
		             ...
		             <tr v-for="(vo,index) in store.food_list" :key="index"
		                class="link" @click="store.foodSelect(vo.contentid,vo.title,vo.image1)"
		             >
		               <td>
